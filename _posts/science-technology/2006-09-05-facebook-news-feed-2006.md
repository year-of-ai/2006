---
title: Facebook's News Feed and Open Registration
date: 2006-09-05
categories:
- Science & Technology
tags:
- social media
- web 2.0
excerpt: 'In September 2006, Facebook made two changes that transformed it from a college-oriented directory into a mass-market social platform: it introduced the **News Feed** and it opened registration to the general public. On **September 5, 2006**, Facebook launched the News Feed, an automatically…'
preview: "/images/previews/science-technology.svg"
permalink: "/news/science-technology/facebook-news-feed-2006/"
---

**Key figures**: Mark Zuckerberg (co-founder and CEO), Ben Parr (organizer of the user protest), Ruchi Sanghvi (engineer who led News Feed development)
...
The year's developments fit within the participatory, user-generated turn that *Time* magazine recognized in December 2006 by naming ["You"]({{ '/news/society-economics/time-you-person-of-the-year/' | relative_url }}) its Person of the Year, alongside the [launch of Twitter]({{ '/news/science-technology/twitter-launch/' | relative_url }}) and [Google's acquisition of YouTube]({{ '/news/science-technology/google-acquires-youtube/' | relative_url }}).

## Sources

- [History of Facebook — Wikipedia](https://en.wikipedia.org/wiki/History_of_Facebook)
- [Feed (Facebook) — Wikipedia](https://en.wikipedia.org/wiki/Feed_(Facebook))
- [Facebook Just Launched Open Registrations — TechCrunch (Sept 26, 2006)](https://techcrunch.com/2006/09/26/facebook-just-launched-open-registrations/)
- [Inside the Backlash Against Facebook — TIME (Sept 6, 2006)](https://time.com/archive/6921083/inside-the-backlash-against-facebook/)
- [Ben Parr — Wikipedia](https://en.wikipedia.org/wiki/Ben_Parr)
